# Cloud + AI Architecture Blueprint: ogx
...
- **Current proof surface:** Repository-local proof surface for agent runtime reliability and AI workflow orchestration, backed by Node/TypeScript runtime, Container build surface, GitHub Actions validation.
- **Status:** archived-supporting
- **Primary stack:** Node/TypeScript runtime, Container build surface, GitHub Actions validation
